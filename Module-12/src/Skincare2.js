...
function Skincare2() {
    ...
    useEffect(() => {
        fetch('http://localhost:5000/skincare2')
            .then(res => res.json())
        ...
        <>
            ...
            <nav aria-label="breadcrumb" className='w2 mt-5 m-auto'>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><Link to='/skincare' className='text-dark text-decoration-none'>Skin care</Link></li>

                    <li class="breadcrumb-item active" aria-current="page">Page 2</li>
                </ol>
            </nav>
            <p className='display-2 w2 m-auto fw-bold'>Skin care</p>
            <div className='w2 m-auto mt-5'>
                <span>Showing 9–13 of 13 results</span>
            ...
            <div className='text-center col border border-dark ho1 rounded-0 py-2'>
                    <Link to='/skincare' className='text-decoration-none'><i className='fa-solid fa-arrow-left'></i></Link>
                </div>
                <div className='text-center col border border-dark rounded-0 py-2 ho1'>
                <Link to='/skincare' className='text-decoration-none'>1</Link>
                </div>
                <div className='text-center col border border-dark bg-dark text-light rounded-0 py-2'>
                2
                </div>
            </div>
            <Footer />
