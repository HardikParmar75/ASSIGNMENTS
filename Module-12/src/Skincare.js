...
function Skincare() {
    ...
    useEffect(() => {
        fetch('http://localhost:5000/skincare1')
            .then(res => res.json())
    ...
    return (
        <>
            ...
            <div className='w2 m-auto mt-5'>
                <span>Showing 1–8 of 13 results</span>
            ...
            <div className='mt-5 row w-25 gap-3 px-5'>
                ...
                <Link to='/skincare2' className='text-decoration-none'>2</Link>
                </div>
                <div className='text-center col border border-dark ho1 rounded-0 py-2'>
                    <Link to='/skincare2' className='text-decoration-none'><i className='fa-solid fa-arrow-right'></i></Link>
                </div>
