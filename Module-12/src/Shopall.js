...
function Shopall() {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/shopall1')
      .then(res => res.json())
  ...
  return (
    <>
      ...
      <div className='w2 m-auto mt-5'>
        <span>Showing 1–8 of 20 results</span>
      ...
      <div className='mt-5 row w-25 gap-3 px-5'>
        <div className='text-center col border border-dark rounded-0 py-2 bg-dark text-light'>
          1
        </div>
        <div className='text-center col border border-dark ho1 rounded-0 py-2'>
          <Link to='/shopall2' className='text-decoration-none'>2</Link>
        </div>
        <div className='text-center col border border-dark ho1 rounded-0 py-2'>
          <Link to='/shopall2' className='text-decoration-none'>3</Link>
        </div>
        <div className='text-center col border border-dark ho1 rounded-0 py-2'>
          <Link to='/shopall2' className='text-decoration-none'><i className='fa-solid fa-arrow-right'></i></Link>
        </div>
      </div>
      <Footer />
    </>
